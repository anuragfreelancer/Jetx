        ...
        onPress={()=>navigation.navigate(ScreenNameEnum.JetDetails)}
         >
          <ImageBackground source={item.image} style={styles.image} >
            <Image source={imageIndex.redSave} style={{height:24,width:24,marginLeft:7,marginTop:9}} resizeMode='contain'/>
            </ImageBackground>
  ...
  return (
    <SafeAreaView style={{
        ...
        backgroundColor:"white"
          ...
          <StatusBarComponent/>
          <CustomHeader imageSource={imageIndex.backorange} label={"Search Flight"}/>
