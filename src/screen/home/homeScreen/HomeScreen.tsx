...
//     <TouchableOpacity 
//       style={styles.card}
//       onPress={() => navigation.navigate(ScreenNameEnum.SearchFlight, { flightData: item })}
//     >
...
//       ]}
//       onPress={() => navigation.navigate(ScreenNameEnum.FlightDetails, { flight: item })}
//     >
//       {index === 0 && (
...
//                     <Image source={imageIndex.flight_takeoff} style={styles.inputIcon} />
//                     <TextInput
//                       placeholder="Departure city"
//                       placeholderTextColor="#999"
//                       style={styles.inputField}
//                       value={searchParams.origin}
//                       onChangeText={(text) => setSearchParams(prev => ({ ...prev, origin: text }))}
//                     />
//                   </View>
//                 </View>
...
//                   <View style={styles.inputWithIcon}>
//                     <Image source={imageIndex.flight_land} style={styles.inputIcon} />
//                     <TextInput
//                       placeholder="Destination city"
//                       placeholderTextColor="#999"
//                       style={styles.inputField}
//                       value={searchParams.destination}
//                       onChangeText={(text) => setSearchParams(prev => ({ ...prev, destination: text }))}
//                     />
//                   </View>
//                 </View>
//               </View>
...
//                 <DateTimePicker
//                   value={getCurrentDate(selectedDateType)}
//                   mode="date"
...
//                   <Image source={imageIndex.arrow_right} style={styles.arrowIcon} />
//                 </TouchableOpacity>
//               </View>
...
//                   <Image source={imageIndex.no_data} style={styles.noDataIcon} />
